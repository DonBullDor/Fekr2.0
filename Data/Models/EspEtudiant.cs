...
namespace Domain.Models
{
    public partial class EspEtudiant
    {
        public EspEtudiant()
        {
            ...
            EspAbscence = new HashSet<EspAbscence>();
            EspAbsence = new HashSet<EspAbsence>();
            EspAbsenceNew = new HashSet<EspAbsenceNew>();
            EspAssRubEtIns = new HashSet<EspAssRubEtIns>();
            EspConvocation = new HashSet<EspConvocation>();
        ...
        public virtual ICollection<EspAbscence> EspAbscence { get; set; }
        public virtual ICollection<EspAbsence> EspAbsence { get; set; }
        public virtual ICollection<EspAbsenceNew> EspAbsenceNew { get; set; }
        public virtual ICollection<EspAssRubEtIns> EspAssRubEtIns { get; set; }
        public virtual ICollection<EspConvocation> EspConvocation { get; set; }
        ...
        public virtual ICollection<EspMoyPanierEtudiant> EspMoyPanierEtudiant { get; set; }
        public virtual ICollection<EspMoyUeEtudiant> EspMoyUeEtudiant { get; set; }
        public virtual ICollection<EspNote> EspNote { get; set; }
        public virtual ICollection<EspReglementOnline> EspReglementOnline { get; set; }
        public virtual ICollection<EspRemarqueAbsence> EspRemarqueAbsence { get; set; }
        public virtual ICollection<EspTestEtud> EspTestEtud { get; set; }
        public virtual ICollection<Fichepfe> Fichepfe { get; set; }
        ...
        public virtual ICollection<Quitus> Quitus { get; set; }
