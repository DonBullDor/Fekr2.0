...
{
    public class ParentJwtMiddleware
    {
        private readonly RequestDelegate _next;

        private readonly AppSettings _appSettings;

        public ParentJwtMiddleware(
        ...
        public async Task
        Invoke(HttpContext context, IParentLoginService userService)
        {
            var token =
                context
                    .Request
        ...
        private void attachUserToContext(
            HttpContext context,
            IParentLoginService userService,
            string token
        )
        {
            try
            {
                ...
                context.Items["Parent"] = userService.GetById(userId);
            }
            catch
            {
